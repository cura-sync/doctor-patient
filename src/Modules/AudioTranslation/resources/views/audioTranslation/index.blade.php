    ...
    <loading></loading>
        ...
        <div class="w-full lg:w-1/3 flex flex-col gap-4">
            <div class="relative bg-white rounded-2xl shadow-xl overflow-hidden mb-6">
                ...
                <img src="{{ asset('resources/bg_abstract_3.png') }}" alt="CuraVox" class="w-full h-64 object-cover rounded-t-2xl z-0">
                <div class="absolute bottom-6 left-6 text-4xl font-bold z-20">
                    <span class="text-white">Cura</span><span class="text-gray-300">Vox</span>
                </div>
            </div>
            <div class="bg-white p-4 rounded-xl shadow-xl">
                ...
                <div class="border-2 border-dashed border-gray-300 rounded-lg p-4 flex flex-col items-center justify-center">
                    <input id="fileInput" type="file" accept=".mp3,.wav,.m4a" class="hidden" onchange="angular.element(this).scope().main.onFileChange(event)">
                    ...
                    <table class="min-w-full text-sm text-left">
                        ...
                        <tbody>
                            <tr ng-repeat="row in main.gridData" class="border-b last:border-0">
                                ...
                                <td class="py-2 px-3">
                                    <a href="/audioTranslation/view/@{{ row.id }}" class="bg-blue-500 hover:bg-blue-700 text-white px-4 py-1 rounded">View</a>
                                </td>
