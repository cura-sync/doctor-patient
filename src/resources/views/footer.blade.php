...
$footerLinks = [
    ...
    'Features' => [
        'CuraLex' => route('curalex'),
        'CuraVox' => route('curavox'),
        'CuraTempus' => route('curatempus'),
    ],
    'Support' => [
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        @foreach($links as $name => $url)
                            <li>
                                <a href="{{ $url }}" class="text-gray-400 hover:text-white transition duration-150 ease-in-out">
                                    {{ $name }}
                                </a>
                            </li>
                        @endforeach
        ...
        <div class="mt-12 pt-8 border-t border-gray-800">
            ...
            <div class="mt-8 text-center text-gray-400">
                <p>&copy; {{ date('Y') }} CuraSync. All rights reserved.</p>
            </div>
        </div>
    </div>
</footer>